...
> implements ControllerCrudOperations<Entity, ID>
{
  ...
  public async create(
    ...
    try {
      const savedEntity = await this.service.createEntity(createDto);
  ...
  public async findAll(
    ...
    try {
      const allEntity = await this.service.findAllEntity();
  ...
  public async findWithPaginator(
    ...
    try {
      const allEntity = await this.service.findWithPaginator(
        Number(page),
        Number(limit),
      );
  ...
  public async findOne(
    ...
    try {
      const entity = await this.service.findOneEntity(id);
  ...
  public async update(
    ...
    try {
      const updatedEntity = await this.service.updateEntity(id, updateDto);
